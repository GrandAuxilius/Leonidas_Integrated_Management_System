...
<td>
  @if ($staffUser->accountStatus == 'Active')
      <span class="bg-lightgreen badges">{{ $staffUser->accountStatus }}</span>
  @elseif ($staffUser->accountStatus == 'Locked')
      <span class="bg-lightred badges">{{ $staffUser->accountStatus }}</span>
  @endif
</td>
